...
/* ---------------- Modal de instruções ---------------- */
const modalInstrucoesOverlay = document.getElementById('modalInstrucoesOverlay');
document.getElementById('btnInstrucoes').addEventListener('click', () => {
  modalInstrucoesOverlay.classList.add('open');
  document.body.style.overflow = 'hidden';
});
document.getElementById('modalInstrucoesClose').addEventListener('click', () => {
  modalInstrucoesOverlay.classList.remove('open');
  document.body.style.overflow = '';
});
modalInstrucoesOverlay.addEventListener('click', (e) => {
  if (e.target === modalInstrucoesOverlay) {
    modalInstrucoesOverlay.classList.remove('open');
    document.body.style.overflow = '';
  }
});
...
function gerarDiagnostico(dados) {
  ...
  document.querySelectorAll('.recon-tab').forEach((t) => t.classList.remove('active'));
  document.querySelectorAll('.recon-panel').forEach((p) => p.classList.remove('active'));
  document.querySelector('.recon-tab[data-tab="visual"]').classList.add('active');
  document.getElementById('panel-visual').classList.add('active');
  ...
  DIMENSIONS.forEach((dim, dimIdx) => {
    dim.questions.forEach((question, qIdx) => {
      ...
      tr.innerHTML = `
        ...
        <td class="col-eixo">${dim.short}</td>
        <td>${question}</td>
